// Copyright (c) YugaByte, Inc.  // // Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except
...
public class MultiTableMultiIndexInserts extends AppBase {
  ...
  public void createTablesIfNeeded() throws Exception {
    ...
    statement.execute(String.format("CREATE TABLE %s (id uuid NOT NULL, a2_id uuid NOT NULL, " +
                                    ...
                                    getTableName("a1a")));
    statement.execute(String.format("CREATE TABLE %s (id uuid primary key, json jsonb,t integer, " +
    ...
    statement.execute(String.format("CREATE INDEX %s ON %s (t);", getTableName("a1_t_idx"),
                                    getTableName("a1")));
    statement.execute(String.format("CREATE INDEX %s ON %s (f_id_1); ", getTableName("a1_f_id_1_idx"),
                                    getTableName("a1")));
    statement.execute(String.format("CREATE INDEX %s ON %s (f_id_2);", getTableName("a1_f_id_2_idx"),
                                    getTableName("a1")));
    statement.execute(String.format("CREATE INDEX %s ON %s (id);", getTableName("a1a_id_idx"),
                                    getTableName("a1a")));
    statement.execute(String.format("CREATE INDEX %s ON %s (t);", getTableName("a1a_t_idx"),
                                    getTableName("a1a")));
    statement.execute(String.format("CREATE INDEX %s ON %s (a2_id);", getTableName("a1a_a2_id_idx"),
                                    getTableName("a1a")));
    statement.execute(String.format("CREATE INDEX %s ON %s (t);", getTableName("a2_t_idx"),
                                    getTableName("a2")));
    statement.execute(String.format("CREATE INDEX %s ON %s (t);", getTableName("a3_t"),
                                    getTableName("a3")));
    statement.execute(String.format("CREATE INDEX %s ON %s (t);", getTableName("a3a_t_idx"),
                                    getTableName("a3a")));
    statement.execute(String.format("CREATE INDEX %s ON %s (a2_id);", getTableName("a3a_a2_id_idx"),
                                    getTableName("a3a")));
    statement.execute(String.format("CREATE INDEX %s ON %s (a3_id);", getTableName("a3a_a3_id_idx"),
                                    getTableName("a3a")));
    statement.execute(String.format("CREATE INDEX %s ON %s (t);", getTableName("d_t_idx"),
                                    getTableName("d")));
    statement.execute(String.format("CREATE INDEX %s ON %s (mv_id);", getTableName("d_mv_idx"),
                                    getTableName("d")));
    statement.execute(String.format("CREATE INDEX %s ON %s (m_id);", getTableName("m_idx"),
                                    getTableName("m")));
